...
smpsHeaderStartSong = 3
	smpsHeaderVoice     S3_PresSega_Voices
	smpsHeaderChan      $06, $03
	smpsHeaderTempo     $01, $10

	smpsHeaderDAC       S3_PresSega_DAC
	smpsHeaderFM        S3_PresSega_FM1,	$0D, $10
	smpsHeaderFM        S3_PresSega_FM2,	$0D, $1B
	smpsHeaderFM        S3_PresSega_FM3,	$01, $05
	smpsHeaderFM        S3_PresSega_FM4,	$0D, $18
	smpsHeaderFM        S3_PresSega_FM5,	$0D, $13
	smpsHeaderPSG       S3_PresSega_PSG1,	$01, $01, $00, $00
	smpsHeaderPSG       S3_PresSega_PSG2,	$01, $01, $00, $00
	smpsHeaderPSG       S3_PresSega_PSG3,	$00, $04, $00, $00
...
S3_PresSega_Loop04:
	...
	smpsLoop            $00, $04, S3_PresSega_Loop04
	smpsStop
...
S3_PresSega_Loop03:
	...
	smpsLoop            $00, $04, S3_PresSega_Loop03
	smpsStop
...
S3_PresSega_FM3:
	...
	smpsAlterPitch      $F4
	smpsSetvoice        $01
	smpsCall            S3_PresSega_Call02
	smpsCall            S3_PresSega_Call03
	dc.b	nE2, $05, nRst, $01, nRst, $06
	smpsCall            S3_PresSega_Call04
...
S3_PresSega_Loop00:
	smpsCall            S3_PresSega_Call00
	smpsLoop            $00, $08, S3_PresSega_Loop00

S3_PresSega_Loop01:
	smpsCall            S3_PresSega_Call01
	smpsLoop            $00, $04, S3_PresSega_Loop01

S3_PresSega_Loop02:
	smpsCall            S3_PresSega_Call00
	smpsLoop            $00, $04, S3_PresSega_Loop02
	smpsPan             panLeft, $00
	smpsStop
...
S3_PresSega_Loop05:
	...
	dc.b	nB6, $06, nB6
	smpsPSGAlterVol     $04
	smpsLoop            $00, $03, S3_PresSega_Loop05
	dc.b	nB6, $06, nB6
	smpsPSGAlterVol     $FC
	dc.b	nB6, $06, nB6
	smpsPSGAlterVol     $04
